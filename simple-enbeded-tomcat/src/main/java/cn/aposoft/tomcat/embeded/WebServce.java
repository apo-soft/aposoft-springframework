...
public class WebServce {
    ...
    private void configConnector(Connector connector) {
        ...
        connector.setProperty("maxThreads", Integer.toString(this.maxThreads));
        connector.setProperty("acceptCount", Integer.toString(this.acceptCount));
        connector.setProperty("disableUploadTimeout", Boolean.toString(true));
        connector.setProperty("enableLookups", Boolean.toString(false));
    }
